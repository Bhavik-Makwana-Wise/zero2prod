...
impl EmailClient {
    ...
    pub fn new(base_url: Url, sender: SubscriberEmail, authorization_token: Secret<String>) -> Self {
        Self {
            sender,
            http_client: Client::builder().connect_timeout(std::time::Duration::from_secs(10))
                .build()
                .unwrap(),
            base_url,
            authorization_token
...
mod tests {
    ...
    async fn send_email_sends_the_expected_request() {
        ...
        // Assert mock conditions when going out of scope
    }
